...
export const getSingleSnippet = ({path,summary,response,error400,error404,error500,params} : IbaseStruct & {error400: any,params: any, error404: any}) => ({
  method: "get" as const,
  path: path,
  summary,
  tags: ['Snippet'],
...
export const postSnippetSimilaritySearch = ({path,summary,send,response,error400,error404,error500} : IbaseStruct & {send: any, error400: any, error404: any}) => ({
    method: "post" as const,
    path: path,
    summary,
    tags: ['Snippet'],
    ...
    responses: {
        ...
        404: {
            description: "Snippet/User not found",
            content: {'application/json': {schema : error404}}
        },
        500: {
            description: "server error",
